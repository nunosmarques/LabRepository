	...
	case "laboratorios":
		echo '<form method="post" action="index.php?s=laboratorios" class="procura" id="laboratorios">
				...
				<p>
					...
					<br />
					<input type="text" name="equip" id="e.equipamento" placeholder="Camara Municipal">
				</p>
				
				<p>
					<label>Tipo Equipamento: </label>
					<br />
					<input type="text" name="tequip" id="et.equipamentotipo" placeholder="Camara Municipal">
				</p>
