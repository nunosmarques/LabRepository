...
//INDIVIDOS
$query = "SELECT * FROM laboratorioindividuo lab
		  INNER JOIN labdir.individuo ind = lab.laboratorio_idlaboratorio = lab on ind.idindividuo
		  WHERE individuo_idindividuo = 2 AND ind.deleted='N'";
//
echo $query;
