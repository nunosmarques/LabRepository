...
if(isset($_POST['data']) && !empty($_POST['data'])){
	...
	$query .= "SELECT * FROM labdir.individuo id
			   LEFT JOIN labdir.laboratorioindividuo labi ON  id.idindividuo = labi.individuo_idindividuo
			   LEFT JOIN labdir.laboratorio lab ON labi.laboratorio_idlaboratorio = lab.idlaboratorio
			   LEFT JOIN labdir.instituicao i ON lab.instituicao_idinstituicao = i.idinstituicao
			   WHERE ".$string." GROUP BY id.idindividuo ".$limite;
...
}else{$query .= "SELECT * FROM individuo WHERE deleted = 'N' ";
}
