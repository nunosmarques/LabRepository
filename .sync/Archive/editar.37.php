...
<form method="post" action="inserir.php"  class="xpto" id="0">
    <fieldset>
        ...
        <label>Instituição:</label>'.
        $result =$comb->combox("instituicao",$return[0][2])
        .'<br>
        <label>Morada:</label>
        <input type="text" name ="morada" value="'.$return[0][3].'"><br>
        <label>Codigo-Postal:</label>
        ...
        <label>Concelho:</label>'.
        $result =$comb->combox("concelho",$return[0][13])
        .'<br>
        <label>Apresentação:</label><br>
        <textarea name="apresentacao" rows="4" cols="50" value="'.$return[0][14].'"></textarea><br>
        <label>Logo:</label>
