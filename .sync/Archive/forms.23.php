...
<form method="post" action="inserir.php" class="xpto" id="0">
    <fieldset>
       ...
       <?php echo $result =$lab_crud->combox("distrito");?>
...
<form method="post" action="inserir.php"  class="xpto" id="0">
    <fieldset>
        ...
        <?php echo $result =$lab_crud->combox("instituicaotipo");?><br>
        <label>Morada:</label>
        ...
        <label>Concelho:</label>
        <?php echo $result =$lab_crud->combox("concelho");?>
        <input type="hidden" name="deleted" value="N">
...
<form method="post" action="inserir.php"  class="xpto" id="0">
    <fieldset>
        ...
        <label>Instituição:</label>
        <?php echo $result =$lab_crud->combox("instituicao");?><br>
        <label>Morada:</label>
        <input type="text" name ="morada"><br>
        <label>Codigo-Postal:</label>
        <input type="text" name ="codigopostal"><br>
        ...
        <input type="text" name ="fax"><br>
        <label>Concelho:</label>
        <?php echo $result =$lab_crud->combox("concelho");?><br>
...
<form method="post" action="inserir.php"  class="xpto" id="0">
    <fieldset>
        ...
        <?php echo $result =$lab_crud->combox("individuo");?><br>
        <label>Area:</label>
        <?php echo $result =$lab_crud->combox("area");?><br>
        <label>Ordem:</label>
...
<form method="post"  action="inserir.php" class="xpto" id="0">
    <fieldset>
        ...
        <?php echo $result =$lab_crud->combox("individuo");?><br>
        <label>Laboratório:</label>
        <?php echo $result =$lab_crud->combox("laboratorio");?><br>
...
<form method="post"  action="inserir.php" class="xpto" id="0">
    <fieldset>
        ...
        <?php echo $result =$lab_crud->combox("mediatipo");?><br>
        <input type="hidden" name="deleted" value="N">
...
<form method="post" action="inserir.php"  class="xpto" id="0">
    <fieldset>
        ...
        <?php echo $result =$lab_crud->combox("equipamentotipo");?><br>
        <input type="hidden" name="deleted" value="N">
...
<form method="post"  action="inserir.php" class="xpto" id="0">
    <fieldset>
        ...
        <?php echo $result =$lab_crud->combox("laboratorio");?><br>
        <label>Equipamento:</label>
        <?php echo $result =$lab_crud->combox("equipamento");?><br>
        <input type="hidden" name="deleted" value="N">
