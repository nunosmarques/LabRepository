...
<form method="post" action="inserir.php" class="xpto" id="0">
    <fieldset>
       ...
       $result =$lab_crud->combox("distrito",NULL).'
        ...
        <br><button type="submit" form="0">Adicionar</button>
    </fieldset>
</form>
        ';
        break;
...
';
    ...
    case "laboratorio":
        echo '
<form method="post" action="inserir.php"  class="xpto" id="0"enctype="multipart/form-data">
    <fieldset>
...
<form method="post" action="inserir.php"  class="xpto" id="0">
    <fieldset>
        ...
        '.$result =$lab_crud->combox("equipamentotipo",NULL).'<br>
        <input type="hidden" name="deleted" value="N">
...
<form method="post"  action="inserir.php" class="xpto" id="0" enctype="multipart/form-data">
    <fieldset>
        ...
        <label>Laboratório:</label>
        '.$result =$lab_crud->combox("laboratorio",NULL).'<br>
        <label>Tipo de media:</label>
        '.$result =$lab_crud->combox("mediatipo",NULL).'<br>
        <input type="hidden" name="deleted" value="N">
...
<form method="post" action="inserir.php"  class="xpto" id="0">
    <fieldset>
        ...
        '.$result =$lab_crud->combox("individuo",NULL).'<br>
        <label>Area:</label>
        '.$result =$lab_crud->combox("area",NULL).'<br>
        <label>Ordem:</label>
...
<form method="post"  action="inserir.php" class="xpto" id="0">
    <fieldset>
        ...
        '.$result =$lab_crud->combox("laboratorio",NULL).'<br>
        <label>Equipamento:</label>
        '.$result =$lab_crud->combox("equipamento",NULL).'<br>
        <input type="hidden" name="deleted" value="N">
